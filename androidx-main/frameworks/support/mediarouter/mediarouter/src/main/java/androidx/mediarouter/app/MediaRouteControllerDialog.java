...
public class MediaRouteControllerDialog extends AlertDialog {
    ...
    private boolean isIconChanged() {
        Bitmap newBitmap = mMetadata == null ? null : mMetadata.getBitmap(MediaMetadataCompat.METADATA_KEY_ALBUM_ART);
    ...
    private class FetchArtTask extends android.os.AsyncTask<Void, Void, Bitmap> {
        ...
        FetchArtTask() {
            Bitmap bitmap = mMetadata == null ? null : mMetadata.getBitmap(MediaMetadataCompat.METADATA_KEY_ALBUM_ART);;
